...
{{--                <input type="range" min="{{ \App\Actions\TrainCharacterAction::MIN_ENERGY_TO_TRAIN }}" class="form-control" max="{{ $character->energy }}" value="{{ $character->energy }}" onchange="onChange(this.value)" name="energy">--}}
                ...
                <div class="row">
                    <div class="col-4">
                        <button type="submit" name="type" value="light" class="btn btn-block btn-success">Light Training (-10 <i class="fas fa-bolt mr-1"></i></button>
                    </div>
                    <div class="col-4">
                        <button type="submit" name="type" value="average" class="btn btn-block btn-primary">Average Training (-50 <i class="fas fa-bolt mr-1"></i></button>
                    </div>
                    <div class="col-4">
                        <button type="submit" name="type" value="heavy" class="btn btn-block btn-danger">Heavy Training (-100 <i class="fas fa-bolt mr-1"></i>)</button>
                    </div>
                </div>
            </form>
        @else
